...
# Algunos tipos de problemas que pueden resolverse con la ayuda de computadoras y otras máquinas
...
.pull-left[
<figure>
  <img src="img/stepped-reckoner.jpg" />
</figure>
]
.pull-right[
  <figcaption>
    <small>Réplica de <a href="https://es.wikipedia.org/wiki/Stepped_Reckoner">stepped reckoner</a>: máquina de cálculo inventada por Gottfried Leibniz alrededor de 1670. Fue la primera calculadora capaz de realizar las cuatro operaciones aritméticas básicas. Fuente: <a href="https://commons.wikimedia.org/wiki/File:Leibnitzrechenmaschine.jpg">Kolossos</a>. <p><p><em>"Es deplorable que las personas más excelentes desperdicien su tiempo haciendo cálculos, cuando cualquiera puede realizarlos acertadamente con la ayuda de una máquina."</em> (Gottfried Leibniz).</small>
  </figcaption> 
]
---
# Algunos tipos de problemas que pueden resolverse con la ayuda de computadoras y otras máquinas
...
.pull-left[
<figure>
  <img src="img/bombe.jpg" />
</figure>
]
.pull-right[
  <figcaption>
    <small>Recreación de <a href="https://es.wikipedia.org/wiki/Bombe">Bombe</a>: dispositivo electromecánico de uso específico utilizado por los criptólogos británicos para ayudar a descifrar las señales cifradas por la máquina alemana <a href="https://es.wikipedia.org/wiki/Enigma_(m%C3%A1quina)">Enigma</a> durante la Segunda Guerra Mundial. Fuente: <a href="https://es.wikipedia.org/wiki/Bombe#/media/Archivo:TuringBombeBletchleyPark.jpg">Sarah Hartwell</a>.</small>
  </figcaption> 
]
---
...
# Algunas sugerencias para programar
